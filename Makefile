...
default: nrf52840_xxaa compiledb
...
.PHONY: flash flash_mbr erase compiledb
...
compiledb:
	@echo Generating the compile database
	@compiledb -o $(OUTPUT_DIRECTORY)/compile_commands.json make -Bnwk > /dev/null
