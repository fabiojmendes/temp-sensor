...
#define ONEWIRE_CRC16 0
    ...
    static bool ow_check_crc16(const uint8_t* input, uint16_t len, const uint8_t* inverted_crc, uint16_t crc = 0);
    ...
    static uint16_t ow_crc16(const uint8_t* input, uint16_t len, uint16_t crc = 0);
#endif
#endif
